export default function CardPerson() {
    return (
      <div className="h-[600px] w-full max-w-[350px] sm:max-w-[300px] md:max-w-[350px] lg:max-w-[400px] overflow-hidden rounded-lg bg-[#ebf3fe] dark:bg-[#4477CE] bg-opacity-20 p-6">
